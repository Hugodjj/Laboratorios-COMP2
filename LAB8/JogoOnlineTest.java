...
public class JogoOnlineTest {
    ...
    public void TestarCadastro(){
        ...
        assertEquals(9, Jogador.ListaJogadores.size());
    }
    ...
    @Test
    public void TesteRanking_e_OrdemLexicografica() throws SenhaInvalidaException, UsuarioInexistenteException {
        ...
        //Primeiro colocado deve ser o jogador JACARE pois após a partida terá 1002 pontos.
        assertEquals("JACARE",JogoOnline.obterRanking().get(0).getNome());

        //Primeiro colocado deve ser o jogador BATMAN porque seu nome vem antes dos demais na ordem do dicionário;
        assertEquals("BATMAN",JogoOnline.obterJogadoresEmOrdemAlfabetica().get(0).getNome());
    }
}
